...
public class ResponseToBoardTranslatorTest {
    ...
    public void translateNormalCase() throws IOException {
        ...
        assertThat(trainDeparture.getVehicle()).isEqualTo("BE.NMBS.IC2005");
    ...
    public void translateCanceledTrain() throws IOException {
        ...
        assertThat(trainDeparture.getVehicle()).isEqualTo("BE.NMBS.IC437");
    ...
    public void translateUndoubledTrain() throws IOException {
        ...
        assertThat(board.getDepartures().get(0).getVehicle()).isEqualTo("BE.NMBS.S322580");
        assertThat(board.getDepartures().get(30).getVehicle()).isEqualTo("BE.NMBS.IC3133");
        assertThat(board.getDepartures().get(31).getVehicle()).isEqualTo("BE.NMBS.IC4312");
        assertThat(board.getDepartures().get(32).getVehicle()).isEqualTo("BE.NMBS.IC4312");
        assertThat(board.getDepartures().get(49).getVehicle()).isEqualTo("BE.NMBS.IC4313");
    }
    ...
    public void translateSpecialDateTrain() throws IOException {
        ...
        assertThat(trainDeparture.getVehicle()).isEqualTo("BE.NMBS.S23672");
        assertThat(trainDeparture.getDelay()).isEqualTo(0);
    }
