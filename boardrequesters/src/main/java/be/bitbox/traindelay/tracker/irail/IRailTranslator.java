...
enum IRailTranslator {
    ...
    private static final String UNKNOWN_VEHICLE = "UNKNOWN";
    ...
    private TrainDeparture translateFrom(Departure departure) {
        ...
        String vehicle = getVehicleFrom(departure.getVehicle());
        Platforminfo platforminfo = departure.getPlatforminfo();
        return aTrainDeparture(time, departure.getDelay(), canceled, vehicle, getPlatform(platforminfo), getPlatformChanged(platforminfo));
    }

    private String getVehicleFrom(String vehicle) {
