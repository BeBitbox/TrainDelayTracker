...
public class DepartureEventToDynamoDB {
    ...
    public DepartureEventToDynamoDB(IDynamoDBMapper dynamoDBMapper, EventBus eventBus) {
        this.dynamoDBMapper = dynamoDBMapper;
        eventBus.register(this);
    }

    @Subscribe
    public void subscribeDepartureEvent(TrainDepartureEvent trainDepartureEvent) {
        try {
